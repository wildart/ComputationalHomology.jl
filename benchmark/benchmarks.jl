...
suite["parts"] = BenchmarkGroup(["components"])
...
suite["construction"]["lowernbrs-small"] = @benchmarkable ComputationalHomology.lowernbrs(Csml, 10, Asml)
suite["construction"]["lowernbrs-medium"] = @benchmarkable ComputationalHomology.lowernbrs(Cmed, 103, Amed)
suite["construction"]["lowernbrs-big"] = @benchmarkable ComputationalHomology.lowernbrs(Cbig, 1009, Abig)
